...
import gnn_toolbox.registry as registry
from custom_modules.architecture import register_architecture
...
def create_model(experiment):
    ...
    model = registry.registry.architecture[experiment.model.name](**experiment.model.params)
    return model.to(experiment.device)

def create_attack(attack_name):
    attack = registry.registry.attack[attack_name]
    return attack
