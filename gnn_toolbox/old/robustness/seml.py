...
def read_config(config_path):
    ...
    file_path = os.path.join(dir_path, 'rob.yaml')
...
def build_configs_and_run(config_files: Sequence[str] = None, executable: Optional[str] = None,
    ...
    # seml_config, _, experiment_config = read_config(config_files)
