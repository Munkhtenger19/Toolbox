...
def run_experiment(experiment: Dict, artifact_manager):
    ...
    try:
        ...
        # tensorboard_log(experiment_dir, clean_result, prefix='clean_')
    except Exception as e:
        # logging.exception(e)
    ...
    try:
        if(experiment['attack']['scope'] == 'global'):
            ...
            # if experiment['attack']['type'] == 'evasion':
            #     tensorboard_log(experiment_dir, perturbed_result, prefix='perturbed_')
    ...
    # tensorboard_log(experiment_dir, all_result)
    ...
    try:
        if experiment['attack']['type'] == 'poison':
            ...
            perturbed_result = {
                ...
                'logits (raw predictions generated by model) ': logits.cpu().numpy().tolist()
            }
