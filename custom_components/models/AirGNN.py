...
class AirGNN(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, out_channels, nlayers=2, K=2, dropout=0.5, lr=0.01,
                with_bn=False, weight_decay=5e-4, model = 'AirGNN', lambda_amp = 0, alpha=0.1):
