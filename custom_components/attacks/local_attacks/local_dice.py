...
from gnn_toolbox.registration_handler.register_components import register_local_attack
...
class LocalDICE(LocalAttack):
    ...
    def attack(self,
        ...
        add_neighbors_idx = add_neighbors_idx.to(self.device)
